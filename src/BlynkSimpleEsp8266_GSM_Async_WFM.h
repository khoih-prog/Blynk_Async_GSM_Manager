/****************************************************************************************************************************
  BlynkSimpleESP8266_GSM_Async_WFM.h
...
#ifndef BlynkSimpleESP8266_GSM_ASYNC_WFM
#define BlynkSimpleESP8266_GSM_ASYNC_WFM
...
//default to use EEPROM, otherwise, use LittleFS or SPIFFS
    ...
    #warning Using LittleFS in BlynkSimpleEsp8266_GSM_Async_WFM.h
  #else
...
#else
  #include <EEPROM.h>
  #warning Using EEPROM in BlynkSimpleEsp8266_GSM_Async_WFM.h
#endif
...
// -- HTML page fragments
const char BLYNK_GSM_HTML_HEAD[]     /*PROGMEM*/ = "<!DOCTYPE html><html><head><title>Blynk_Async_GSM_ESP8266</title><style>div,input{padding:2px;font-size:1em;}input{width:95%;}\
...
#define TIMEOUT_CONNECT_WIFI			30000
      ...
      //// New DRD/MRD ////
      {
        ...
        //Base::begin(BlynkGSM_ESP8266_config.blynk_token);
        //this->conn.begin(BlynkGSM_ESP8266_config.blynk_server, BlynkGSM_ESP8266_config.blynk_port);
...
#define  CREDENTIALS_FILENAME_BACKUP  BLYNK_F("/gsm_cred.bak")
  ...
  #define BLYNK_EEPROM_START    (EEPROM_START + FLAG_DATA_SIZE)
    ...
    bool checkDynamicData(void)
    {
      ...
      uint16_t offset = BLYNK_EEPROM_START + sizeof(BlynkGSM_ESP8266_config);
      ...
      if (request)
      {
        ...
        if (key == "" && value == "")
        {
          ...
          if ( RFC952_hostname[0] != 0 )
          {
            ...
            result.replace("Blynk_Async_GSM_ESP8266", RFC952_hostname);
          }
          else if ( BlynkGSM_ESP8266_config.board_name[0] != 0 )
          {
            // Or replace only if board_name is valid.  Otherwise, keep intact
            result.replace("Blynk_Async_GSM_ESP8266", BlynkGSM_ESP8266_config.board_name);
          }
...
#endif    // BlynkSimpleESP8266_GSM_ASYNC_WFM
